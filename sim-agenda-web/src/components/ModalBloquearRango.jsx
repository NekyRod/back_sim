...
export default function ModalBloquearRango({ open, profesional, onClose }) {
  ...
  function guardar() {
    // Aquí podrías enviar los rangos bloqueados al backend
    showToast('Rangos bloqueados (simulado).');
    onClose();
  }
  ...
  return (
    <ModalBase open={open} title="Bloquear Rango" onClose={onClose}>
      <div className="modal-content-horario">
        <h3 className="modal-title">Bloquear Rango</h3>
        ...
        <div className="modal-body">
          ...
          <div className="rango-lista-container">
            <div id="lista-bloquear-rangos" className="rango-lista">
              {rangos.map((r, idx) => (
